import type { OrbuSpeechConfiguration } from '@core/config.types'
...
export const ORBU_DEFAULT_SPEECH = deepFreezeOrbuConfiguration({
...
} satisfies OrbuSpeechConfiguration)
