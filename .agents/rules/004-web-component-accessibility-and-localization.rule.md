---
description: Scopes accessibility, localization, reduced motion, host semantics, and closed-shadow behavior for the native orb-voice Web Component.
globs:
  - "src/element/**"
  - "src/factories/**"
...
- Priority: Critical
- Applies: `<orb-voice>` behavior and documentation
