---
description: Scopes accessibility, localization, reduced motion, host semantics, and closed-shadow behavior for the native orbu Web Component.
globs:
  - "src/element/**"
  - "src/factories/**"
...
- Priority: Critical
- Applies: `<orb-u>` behavior and documentation
