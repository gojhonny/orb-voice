---
description: Scopes TypeScript, JavaScript, configuration, formatting, import-order, typing, and secret-handling conventions for Orb Voice engineering changes.
globs:
  - "src/**"
  - "test/**"
  - "cli/**"
