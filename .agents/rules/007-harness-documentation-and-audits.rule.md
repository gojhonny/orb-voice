---
description: Scopes Orb Voice engineering-harness records, navigation, deterministic audits, accurate dates, terminology, and documentation synchronization.
globs:
  - ".agents/**"
  - ".audits/**"
  - "AGENTS.md"
...
2. Harness records describe Orb Voice only and must not retain unrelated product-domain terminology.
