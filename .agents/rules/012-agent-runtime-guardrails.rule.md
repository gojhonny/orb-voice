...
2. Workflows orchestrate existing rules, skills, and real Orbo commands; they must not invent a second CLI or duplicate product requirements.
...
8. Hook scripts are committed, dependency-free Node.js utilities; this exception does not change Rule 008's POSIX-shell-only requirement for the Orbo CLI.
