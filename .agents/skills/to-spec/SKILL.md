---
name: to-spec
description: Use when an owner-approved Orb Voice repository change needs to be synthesized into the next canonical numbered SPEC with acceptance criteria and evidence.
