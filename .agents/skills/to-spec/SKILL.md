---
name: to-spec
description: Use when an owner-approved Orbu repository change needs to be synthesized into the next canonical numbered SPEC with acceptance criteria and evidence.
