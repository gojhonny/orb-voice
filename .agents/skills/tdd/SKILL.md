---
name: tdd
description: Use when implementing or changing a declared Orbu behavior and you need a strict red-to-green loop at a stable public seam with regression evidence.
---
