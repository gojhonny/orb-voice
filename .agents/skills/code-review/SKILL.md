---
name: code-review
description: Use when reviewing Orbu changes for public API compatibility, SSR safety, Web Component lifecycle, voice cancellation, accessibility, tests, packaging, or harness compliance.
---

# Orbu code review procedure
...
8. Run `./cli/orbu check` and report findings by severity with file and behavior evidence.
