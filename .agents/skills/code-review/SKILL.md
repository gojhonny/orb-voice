---
name: code-review
description: Use when reviewing Orbo changes for public API compatibility, SSR safety, Web Component lifecycle, voice cancellation, accessibility, tests, packaging, or harness compliance.
---

# Orbo code review procedure
...
8. Run `./cli/orbo check` and report findings by severity with file and behavior evidence.
