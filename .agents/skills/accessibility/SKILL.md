---
name: accessibility
description: Use when changing Orbu accessibility semantics, reduced-motion behavior, host labeling guidance, transcripts, focus behavior, or assistive-technology expectations.
---

# Accessible Orbu change procedure
...
7. Run `./cli/orbu check` and record evidence in the SPEC.

## Stop conditions

Stop and request an ADR when a change adds built-in semantic content, live-region
behavior, focusability, or keyboard interaction to `<orb-u>`.
