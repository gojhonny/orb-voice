---
name: implement
description: Use when implementing an approved OrbV SPEC or regression fix and you need a disciplined path from reproduction and tests through the narrowest production change and validation.
---

# OrbV implementation procedure
...
6. Run focused tests, then `./cli/orbv check`.
