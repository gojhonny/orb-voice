...
description: Use when adding or changing OrbV context, ADRs, rules, SPECs, skills, workflows, audits, hooks, guardrails, or other engineering-harness artifacts.
---
...
7. Run `./cli/orbv audit` and `./cli/orbv check`.
