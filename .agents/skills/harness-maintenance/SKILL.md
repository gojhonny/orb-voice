...
description: Use when adding or changing Orbo context, ADRs, rules, SPECs, skills, workflows, audits, hooks, guardrails, or other engineering-harness artifacts.
---
...
7. Run `./cli/orbo audit` and `./cli/orbo check`.
