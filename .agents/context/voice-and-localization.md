...
Realtime model/voice defaults live in `src/orb-voice.config.json`; language and
...
Orb Voice does not invent fallback copy, greetings or persona. An explicitly started
