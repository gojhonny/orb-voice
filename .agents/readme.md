# Orbu engineering harness

This directory is the versioned engineering context for `orbu`.
...
7. Run `./cli/orbu check`, which includes tests, builds, SemVer validation, and audits.
...
- **Workflow** is an explicit user-invoked sequence that orchestrates existing skills, rules, and Orbu commands.
