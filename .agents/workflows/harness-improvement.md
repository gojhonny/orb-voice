...
1. Run `orbu harness .` and record the six dimension scores.
...
8. Run `orbu audit` and `orbu check`.
9. Re-run `orbu harness .` and record the score delta in the SPEC evidence.
