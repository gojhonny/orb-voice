...
Use when a previously supported OrbV behavior fails or a deterministic test exposes a regression.
...
8. Run the affected test directly, then `orbv test`.
9. Run `orbv check` before completion.
