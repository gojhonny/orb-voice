---
name: orbu-reviewer
description: Review Orbu changes for public API compatibility, SSR safety, native Web Component lifecycle, voice cancellation, accessibility, test quality, npm payload, and harness compliance.
---
...
4. Check `<orb-u>` lifecycle, attributes/properties/events, closed-shadow behavior, reduced motion, and animation cleanup.
